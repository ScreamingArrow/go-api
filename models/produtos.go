...
func CriaNovoProduto(nome, descricao string, preco float64, quantidade int) {
	...
	insereDadosNoBanco, err := db.Prepare("insert into produtos(nome, descricao, preço, quantidade) values($1, $2, $3, $4)")
	if err != nil {
		panic(err.Error())
	}
...
func AtualizaProduto(id int, nome, descricao string, preco float64, quantidade int) {
	...
	AtualizaProduto, err := db.Prepare("update produtos set nome=$1, descricao=$2, preço=$3, quantidade=$4 where id=$5")
	if err != nil {
		panic(err.Error())
	}
